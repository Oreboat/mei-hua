...
void onAdapterRequestEndedOld(WGPURequestAdapterStatus status, WGPUAdapter adapter, WGPUStringView message, void *userdata1, void *userdata2) {
...
void onDeviceRequestEndedOld(WGPURequestDeviceStatus status, WGPUDevice device, WGPUStringView message, void *userdata1, void *userdata2) {
...
WGPUAdapter getPhysicalDeviceOld() {
    ...
    info.callback = onAdapterRequestEndedOld;
...
void initLogicalDeviceOld() {
    RendererState.wgpu_adapter = getPhysicalDeviceOld();
    assert(RendererState.wgpu_adapter);

    WGPURequestDeviceCallbackInfo info = WGPU_REQUEST_DEVICE_CALLBACK_INFO_INIT;
    info.callback = onDeviceRequestEndedOld;
...
void rendererInitOld() {
    initWebGPUOld();
    initLogicalDeviceOld();
    initRenderTargetOld();
    //initPipeline();
}

void rendererCleanupOld() {
...
void rendererClearOld() {

}

void rendererStartFrameOld() {

}

void rendererEndFrameOld() {

}

void rendererDrawOld() {
